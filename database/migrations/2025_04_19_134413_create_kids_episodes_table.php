...
class CreateKidsEpisodesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kids_episodes', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->string('season');
    ...
    {
        Schema::dropIfExists('kids_episodes');
    }
}
