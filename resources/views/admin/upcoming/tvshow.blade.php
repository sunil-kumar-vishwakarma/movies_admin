    ...
    <div class="container">
        <div class="search-sort">
            <div class="search-container">
                ...
                <input type="text" class="search-input" placeholder="Search TV Show...">
            </div>
            ...
            <section class="videos-list">
                <div class="videos-container">
                    <div class="video-card add-video-card">
                        <a href="{{ route('admin.upcoming.addshow') }}" class="add-video-btn">
                            <span class="add-icon"><i class="fas fa-plus"></i></span>
                            <span class="add-text">Add New TV Show</span>
                        </a>
                        ...
                        <div class="video-image">
                            <div class="video-card-overlay">
                                ...
                                <div class="video-card-icons">
                                    ...
                                    <a href="{{ route('admin.upcoming.edittvshow') }}">
