    ...
    <div class="container">
        ...
        <div class="search-sort">
            <div class="search-container">
                ...
                <input type="text" class="search-input" placeholder="Search Avatar..." id="search-input">
            </div>
...
$('#add-form').on('submit', function(e) {
    ...
    $.ajax({
        url: "{{ route('admin.basic-item-avatar.store') }}",
        method: "POST",
        data: formData,
        contentType: false,
        processData: false,
