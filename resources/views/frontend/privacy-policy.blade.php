  ...
  <body>
    ...
    <main>
      <section class="content">
        ...
        <p>
          SHTube provides a personalized subscription service that allows
          members to access entertainment content...
        </p>
        <h2>1. Information We Collect</h2>
        <p>
          This Privacy Statement explains how we collect, use, and disclose your
          personal information when you use the "SHTube service” to access
          “SHTube content” as those terms are defined in the SHTube Terms of
          Use (SHTube.com/terms). It also explains what privacy rights you have
          and how to exercise them. Certain functionalities or apps that are
          part of the SHTube service may also provide you with contextual
          privacy information or choices, in addition to the information and
          choices described in this Privacy Statement. Please note that this
          Privacy Statement may be easier to navigate when viewed on your web
          browser.
        </p>
