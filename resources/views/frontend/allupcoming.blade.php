    ...
    <main>
      <section class="rent-movie">
        ...
        <div class="card-container">
          <div class="card">
            <img src="image/rajasahab.webp" alt="Kahaani 2" />
          ...
          <div class="card">
            <img src="image/bhootbangla.webp" alt="Kahaani 2" />
            <div class="card-content">
          ...
          <div class="card">
            <img src="image/toxic3.webp" alt="Kahaani 2" />
            <div class="card-content">
              <h3>Ek Badnaam Aashram</h3>
              <p class="time">2 h 2 min <span>2024-03-20</span></p>
              <p class="description">
          ...
          <div class="card">
            <img src="image/jaat1.webp" alt="Kahaani 2" />
            <div class="card-content">
              <h3>Bahubali</h3>
              <p class="time">2 h 2 min <span>2024-03-20</span></p>
              <p class="description">
