    ...
    <main>
      <section class="rent-movie">
        ...
        <div class="card-container">
          <div class="card">
            <img src="image/baalveer.webp" alt="Kahaani 2" />
          ...
          <div class="card">
            <img src="image/akbar.webp" alt="Kahaani 2" />
            <div class="card-content">
          ...
          <div class="card">
            <img src="image/shakalaka.png" alt="Kahaani 2" />
            <div class="card-content">
              <h3>Chhava</h3>
              <p class="time">2 h 2 min <span>2024-03-20</span></p>
              <p class="description">
          ...
          <div class="card">
            <img src="image/tarakmehta.webp" alt="Kahaani 2" />
            <div class="card-content">
              <h3>Ek Badnaam Aashram</h3>
              <p class="time">2 h 2 min <span>2024-03-20</span></p>
              <p class="description">
          ...
          <div class="card">
            <img src="image/mohabbaten.webp" alt="Kahaani 2" />
            <div class="card-content">
              <h3>Bahubali</h3>
              <p class="time">2 h 2 min <span>2024-03-20</span></p>
              <p class="description">
          ...
          <div class="card">
            <img src="image/hatiim.webp" alt="Kahaani 2" />
            <div class="card-content">
              <h3>Game Changer</h3>
              <p class="time">2 h 2 min <span>2024-03-20</span></p>
              <p class="description">
          ...
          <div class="card">
            <img src="image/ridhta.webp" alt="Kahaani 2" />
            <div class="card-content">
              <h3>Chhava</h3>
              <p class="time">2 h 2 min <span>2024-03-20</span></p>
              <p class="description">
